...
public class InterpreterMemory {
    ...
    private void updateValue(VariableDefinitionDataImplementation oldValue, Token varName, Object value, Map<String, VariableDefinitionDataImplementation> values) {
        if (oldValue.getVarDefinitionKey() == LET) {
            checkType(oldValue.getType(), value, varName);
            oldValue.setValue(value);
            this.temporalValues.put(varName.getTokenValue(), oldValue);
        } else {
